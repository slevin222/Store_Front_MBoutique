...
import ourMacaronsBackground from '../assets/images/our-macarons-background.png';
...
export default props => {
    return (
        <div>
            ...
            <div className="classics col lg3">
                <h4>Classics</h4>
                <ul>
                ...
                {/* <div className="imgTwo col lg12">
                    <img src={ourMacaronsBackground} className="ourMacaronsBackground" />
                </div> */}
            </div>
